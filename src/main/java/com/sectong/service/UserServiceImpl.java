...
public class UserServiceImpl implements UserService {
	 ...
	 */
	@Autowired
	public UserServiceImpl(UserRepository userRepository, AuthorityRepository authorityRepository,RedisUtil redisUtil) {
	...
	public User create(UserCreateForm form) {
        ...
        user.setEnabled(1);
        user.setMobileType(form.getMobileType());
    ...
    @Override
    public Object getVerificationCode(String tel) {
        String num = Xioo.getRandNum(6);
        redisUtil.set(tel, num, 300L);
        try {
            Xioo.sms(num, tel);
        } catch (IOException e) {
            e.printStackTrace();
        ...
        LOGGER.info("tel:{} 请求验证码:{}", new Object[]{tel, num});
        return num;
    }
